...
private String datetripturn;
   ...
   /* public DriverDetails(int value) {
    ...
    public DriverDetails(String phoneno, String location, String name) {	
   ...
   // public DriverDetails(long phoneno, String location, String name, String dt,  String datetripturn) {	
    public DriverDetails(String phoneno, String location, String name, Boolean incentiveBool, Date tripDate,  String datetripturn) {
