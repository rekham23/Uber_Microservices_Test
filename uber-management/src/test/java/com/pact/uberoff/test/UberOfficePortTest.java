...
public class UberOfficePortTest {
    ...
    @Pact(provider="billing-details", consumer="uber-ledger")
...
*/
    ...
    public void runTest1() throws RestClientException, IOException {
    	log.info("runTest1():---------------");
        assertEquals(new UberOfficePort(rule1.getConfig().url()).getDriverDetailsUberOfc(), driverDetailResults.toString());
    }
    ...
    public void runTest2() throws RestClientException, IOException {
    	log.info("runTest2():---------------");
        assertEquals(new UberOfficePort(rule1.getConfig().url()).getBillDetailsUberOfc(), driverDetailResults.toString());
    }
